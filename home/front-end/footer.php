                ...
                <div class="row">
					<div class="col-lg-3 col-12">
                        <div class="widget">
                            ...
                            Registered as GLOBAL TRADE PROFESSIONAL ALLIANCE Ltd with Company number FC036728 under the UK company house, 
                            we are a registered institution with solid financial stability and longevity
                             to back our ever-growing reputation as a real power-house in the field of business.
                            <br><br> We have agents working remotely in major cities of the world with our permanent address located in London.
                            </p>
                        </div>
                    </div>											
					<div class="col-lg-3 col-12">
		...
		<div class="footer-bottom bg-dark3">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 col-12 text-md-start text-center"> © 2021 <span class="text-white">Global Trade Proffesional Alliances</span>  All Rights Reserved.</div>
