			  ...
			  <div class="box no-shadow">
				<div class="box-body no-padding mailbox-nav">
				  <ul class="nav nav-pills flex-column">
					...
					<li class="nav-item"><a class="nav-link active" href="starred.php"><i class="ion ion-star"></i>  Starred <span class="label label-warning pull-right">14</span></a>
					</li>
					...
					<div class="table-responsive">
						<table class="table table-hover b-2">
						  ...
						  <tr>
							...
							<td class="mailbox-subject"><a href="read-starred.php"><b>Lorem Ipsum</b> - There are many variations of Ipsum available...</a>
							</td>
